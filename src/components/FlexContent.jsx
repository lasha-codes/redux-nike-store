...
const FlexContent = ({
  ...
  return (
    <>
      ...
      >
        <div className='max-w-lg lg:max-w-none w-full md:text-center lg:flex-col grid items-center md:justify-items-center'>
          ...
          <img
            ...
            className={`w-auto object-fill transitions-theme ${
              ifExists
                ...
                : 'h-72 lg:h-64 md:h-60 sm:h-48 xsm:h-40 transform-rotate-[19deg] hover:rotate-12'
            }`}
          />
        </div>
      </div>
